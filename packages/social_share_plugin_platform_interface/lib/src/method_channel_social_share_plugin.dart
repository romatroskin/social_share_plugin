...
/// An implementation of [SocialSharePluginPlatform] that uses method channels.
class MethodChannelSocialSharePlugin extends SocialSharePluginPlatform {
  /// The method channel used to interact with the native platform.
  @visibleForTesting
  final methodChannel = const MethodChannel('social_share_plugin');
